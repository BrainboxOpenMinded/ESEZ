...
function somfrp_get_template_html( $template_name ) {
	...
	if ( empty( $lost_text ) ) {
		$lost_text = esc_html__( 'Podaj swój adres e-mail lub nazwę użytkownika. <br>Otrzymasz link do utworzenia nowego hasła za pośrednictwem poczty e-mail.', 'frontend-reset-password' );
