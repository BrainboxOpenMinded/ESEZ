    ...
    function input_admin_enqueue_scripts(){
        ...
        acf_localize_data(array(
            'phoneNumberL10n' => array(
                'invalidPhoneNumber'    => _x('Zły numer telefonu',       'Phone Number JS invalidPhoneNumber',   'acfe'),
                'invalidCountry'        => _x('Niepoprawne państwo',            'Phone Number JS invalidCountry',       'acfe'),
                'phoneNumberTooShort'   => _x('Numer telefonu jest za krótki',  'Phone Number JS phoneNumberTooShort',  'acfe'),
                'phoneNumberTooLong'    => _x('Numer telefonu jest za długi',   'Phone Number JS phoneNumberTooLong',   'acfe'),
            )
        ));
